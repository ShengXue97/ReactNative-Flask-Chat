...
class Graph():
    ...
    def dijkstra(self, src, dest):
        ...
        if len(self.out) == 3:
            mockList = [self.sourceLocation + "(Source)", self.destLocation + "(Destination)"]
            results = ("None","None","Walk", self.dist["Destination"], mockList)
            return results
        else:
            results = (self.out[1], self.out[-2], self.busTaken, self.dist["Destination"], self.out)
            return results
        ...
        if (u.node == "Source"):
            ...
            for i in range(len(busStopsNames)):
                ...
                for j in range(len(busesList)):
                    neighbourList.append(Node(str(busStopsNames[i]) + ";" + str(busesList[j]) , busStopToCoordinates[i] / walkingSpeedKMPerSecond))
    ...
    def lessonLocationToTop3BusStops(self, lesssonLocation):
        ...
        coordinates["AS2"] = {"Ventus": 0.33503, "LT13": 0.44107, "KRBusTerminal": 1.86932, "CLB": 1.94632, "AS5": 2.02644}
        coordinates["AS3"] = {"LT13": 0.68379, "Ventus": 0.92678, "AS5": 1.33822, "KRBusTerminal": 1.91614, "OppNUSS": 2.2466}
        coordinates["AS4"] = {"LT13": 0.99415, "AS5": 1.03775, "Ventus": 1.24641, "OppNUSS": 1.92828, "KRBusTerminal": 2.11467}
        ...
        coordinates["AS7"] = {"LT13": 0.62887, "Ventus": 0.92396, "AS5": 1.32474, "KRBusTerminal": 1.77252, "OppNUSS": 2.29309}
        coordinates["AS8"] = {"CLB": 0.59722, "Ventus": 1.60982, "LT13": 1.81381, "IT": 1.90794, "COM2": 2.42495}
        coordinates["BIZ1"] = {"OppHSSML": 0.92698, "TCOMS": 1.2542, "OppTCOMS": 1.2542, "OppNUSS": 1.27802, "BIZ2": 1.28098}
        coordinates["BIZ2"] = {"TCOMS": 0.35161, "OppTCOMS": 0.35161, "OppHSSML": 0.41894, "BIZ2": 0.55577, "COM2": 1.64421}
        coordinates["CAPT"] = {"TCOMS": 0.35161, "OppTCOMS": 0.35161, "OppHSSML": 0.41894, "BIZ2": 0.55577, "COM2": 1.64421}
        coordinates["CELS"] = {"PGP": 2.56213, "S17": 3.00889, "LT27": 3.02335, "PGP HSE 15": 3.23459, "UHall": 3.42918}
        coordinates["COM1"] = {"COM2": 0.67306, "BIZ2": 1.28319, "TCOMS": 1.48496, "OppTCOMS": 1.48496, "OppNUSS": 1.9018}
        coordinates["COM2"] = {"BIZ2": 0.54312, "TCOMS": 0.67799, "OppTCOMS": 0.67799, "COM2": 0.87382, "OppHSSML": 1.05424}
        ...
        coordinates["EH"] = {"OppHSSML": 1.28553, "TCOMS": 1.95254, "OppTCOMS": 1.95254, "BIZ2": 2.06509, "OppNUSS": 2.18105}
        ...
        coordinates["GBT"] = {"IT": 1.41307, "Ventus": 1.45926, "LT13": 1.83213, "CLB": 1.85356, "KRBusTerminal": 2.73763}
        coordinates["HSSMLCR"] = {"BIZ2": 0.65835, "TCOMS": 0.66632, "OppTCOMS": 0.66632, "OppHSSML": 0.71654, "COM2": 1.27404}
        coordinates["I3"] = {"OppHSSML": 1.02483, "TCOMS": 1.67989, "OppTCOMS": 1.67989, "BIZ2": 1.8841, "COM2": 2.92803}
        coordinates["KEVII"] = {"PGP": 0.59092, "PGPR": 1.24947, "PGP HSE 15": 1.53225, "PGP7": 1.95793, "KRMRT": 4.01039}
        ...
        coordinates["LT11"] = {"Ventus": 0.73279, "LT13": 0.86152, "CLB": 1.54783, "AS5": 2.05399, "KRBusTerminal": 2.30023}
        coordinates["LT12"] = {"LT13": 0.46469, "Ventus": 0.60133, "AS5": 1.69129, "KRBusTerminal": 1.86907, "CLB": 2.07712}
        coordinates["LT13"] = {"LT13": 0.24127, "Ventus": 0.36395, "KRBusTerminal": 1.683, "AS5": 1.88712, "CLB": 2.16482}
        ...
        coordinates["LT16"] = {"COM2": 0.42678, "BIZ2": 0.79915, "TCOMS": 0.99563, "OppTCOMS": 0.99563, "OppNUSS": 1.09489}
        coordinates["LT17"] = {"BIZ2": 0.6721, "COM2": 0.76951, "TCOMS": 0.82195, "OppTCOMS": 0.82195, "OppNUSS": 1.06471}
        coordinates["LT18"] = {"TCOMS": 0.43356, "OppTCOMS": 0.43356, "BIZ2": 0.49729, "OppHSSML": 0.53522, "COM2": 1.37154}
        coordinates["LT19"] = {"BIZ2": 0.3586, "TCOMS": 0.53003, "OppTCOMS": 0.53003, "COM2": 0.8606, "OppHSSML": 1.04898}
        ...
        coordinates["LT33"] = {"LT27": 0.31305, "S17": 0.35514, "UHall": 2.19428, "OppUHall": 2.88024, "OppUHC": 5.45378}
        coordinates["LT34"] = {"LT27": 0.30504, "S17": 0.31845, "UHall": 2.12258, "OppUHall": 2.80892, "OppUHC": 5.38817}
        ...
        coordinates["NAK-AUD"] = {"UTown": 2.43867, "Museum": 4.54793, "KV": 4.55051, "RafflesHall": 5.20373, "EA": 5.69284}
        coordinates["PGPH-FR4"] = {"PGPR": 0.6382, "PGP7": 0.77394, "PGP": 1.00599, "PGP HSE 15": 1.77916, "KRMRT": 4.88921}
        ...
        coordinates["RMI"] = {"OppHSSML": 0.58284, "TCOMS": 1.24684, "OppTCOMS": 1.24684, "BIZ2": 1.44691, "COM2": 2.48408}
        ...
        coordinates["SR_LT19"] = {"BIZ2": 0.33734, "TCOMS": 0.50263, "OppTCOMS": 0.50263, "COM2": 0.89186, "OppHSSML": 1.01842}
        coordinates["TC"] = {"UTown": 2.55129, "Museum": 4.99396, "KV": 5.09153, "RafflesHall": 5.72454, "EA": 6.2104}
        coordinates["TH"] = {"AS5": 0.9624, "OppNUSS": 1.79679, "LT13": 2.34013, "KRBusTerminal": 2.47747, "Ventus": 2.70453}
        ...
        coordinates["UTSRC"] = {"UTown": 1.90511, "Museum": 3.19563, "KV": 3.58471, "RafflesHall": 3.91742, "EA": 4.39521}
    ...
    def getNextBusStop(self, busStop, bus):
        hm = {}
        hm["A1"] = ["PGP","KRMRT","LT27","UHall","OppUHC","YIH","CLB","LT13","AS5","COM2","BIZ2","OppTCOMS","PGP7","PGP"]
        hm["A1E"] = ["KRMRT", "LT27", "OppUHC", "CLB", "BIZ2", "PGP"]
        hm["A2"] = ["PGP", "PGPHse15", "TCOMS", "OppHSSML", "OppNUSS", "COM2", "Ventus", "IT", "OppYIH", "Museum", "UHC", "OppUHall", "S17", "OppKRMRT", "PGP"]
        ...
        hm["C"] = ["KRBusTerminal", "JapaneseSch", "KV", "Museum", "UTown", "UHC", "OppUHall", "S17", "LT27", "UHall", "OppUHC", "UTown", "RafflesHall", "EA", "KRBusTerminal"]
        hm["D1"] = ["OppHSSML", "OppNUSS", "COM2", "Ventus", "IT", "OppYIH", "Museum", "UTown", "YIH", "CLB", "LT13", "AS5", "COM2", "BIZ2"]
        hm["D2"] = ["OppTCOMS", "PGP", "KRMRT", "LT27", "UHall", "OppUHC", "Museum", "UTown", "UHC", "OppUHall", "S17", "OppKRMRT", "PGPR", "TCOMS"]
        hm["BTC1"] = ["KRBusTerminal", "KV", "Museum", "YIH", "CLB", "LT13", "AS5", "BIZ2", "PGP", "CollegeGreen", "OTHBldg"]
