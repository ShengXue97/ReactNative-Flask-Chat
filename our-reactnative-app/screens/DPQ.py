...
class Graph():
    ...
    def dijkstra(self, src, dest):
        ...
        print("Total time taken: " + str(self.dist["Destination"]) + " seconds")
    ...
    def e_Neighbours(self, u):
        ...
        if (u.node == "Source"):
            ...
            print(self.busStopToCoordinates(self.sourceLocation))

            if (self.busStopToCoordinates(self.sourceLocation)):
                # If bus stop is given as the source, simply use the bus stop
                busStopsNames.append(self.sourceLocation)

                uC = self.busStopToCoordinates(self.sourceLocation)
                busStopToCoordinates.append(0)
            else:
